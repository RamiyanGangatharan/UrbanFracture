...
- Made an outside portion of the map, Lighting is somewhat broken
- Navmesh update for dealing with outside.
- Fixed the navmesh on the roof causing the AI to spawn on the roof.
